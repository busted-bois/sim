...
├── scripts/
│   ├── install.sh                # Setup venv + git hooks (bash)
│   ├── install.ps1               # Setup venv + git hooks (PowerShell)
│   ├── launch.sh                 # Launch simulator + main.py (bash)
│   ├── launch.ps1                # Launch simulator + main.py (PowerShell)
